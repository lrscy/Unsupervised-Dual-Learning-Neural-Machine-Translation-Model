...
def simple_seq2seq( vocab_size_list,
...
if __name__ == "__main__":
    ...
    vocab_size_list = []
    vocab_size_list.append( len( word_to_idx_dict[language_list[0]] ) )
    vocab_size_list.append( len( word_to_idx_dict[language_list[1]] ) )
